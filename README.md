...
| --- | --- | --- | --- |
| AppSw | `com.jinkennguyen.appsw` | 1.0.2 | rootful, rootless, RootHide |
...
| Lock Frame | `com.jinkennguyen.haloframe` | 3.2.0 | rootful, rootless, RootHide |
...
| SettingSZ | `com.jinkennguyen.settingsz` | 1.0.9 | rootful, rootless, RootHide |
